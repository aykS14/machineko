...
function commentedit(params) {
    ...
    var input_message = '<textarea class="form-control" id="msg_' + params + '" name="modmsg">' + msg + '</textarea><div class="text-right mt-2"><input type="button" class="btn btn btn-secondary btn-sm m-1" id="btcan_' + params + '" onclick="bt_cancel(' + params + ')" value="cancel"><input type="submit" class="btn btn-info btn-sm m-1"  id="btedt_' + params + '" name="edit" value="update"></div>';
